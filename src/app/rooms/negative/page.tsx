  ...
  return (
    <main className="flex">
      ...
      <section className="flex-1 p-8 bg-gray-50">
        <h1 className="text-2xl font-bold text-gray-800 mb-4">🌙 Meditation Room</h1>
        <p className="text-gray-600">Welcome to the meditation room, please relax as much as possible.</p>
